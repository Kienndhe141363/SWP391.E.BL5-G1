<%-- 
    Document   : Checkout
    Created on : Aug 23, 2024, 1:59:37 AM
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7">
                            ...
                            <div class="panel-default">
                                <input id="payment_vnpay" value="vnpay" name="payment_method" type="radio" />
                                <label for="payment_vnpay">VN Pay <img src="assets/img/icon/vnpay.jpg" alt="" style="margin-left: 50px"></label>
                            </div>
                            <div class="panel-default">
